...
h1 {
  ...
  <body>
    ...
    date_default_timezone_set('America/Los_Angeles');
      ...
      switch ($dayofweek) {
        case 1:
          echo "<h1><center>It is Monday!</center></h1>";
          break;
        case 2:
          echo "<h1><center>It is Tuesday!</center></h1>";
          break;
        case 3:
          echo "<h1><center>It is Wednesday!</center></h1>";
          break;
        case 4:
          echo "<h1><center>It is Thursday!</center></h1>";
          break;
        case 5:
          echo "<h1><center>It is Friday!</center></h1>";
          break;
        case 6:
          echo "<h1><center>It is Saturday!</center></h1>";
          break;
        case 0:
          echo "<h1><center>It is Sunday!</center></h1>";
          break;
        default:
